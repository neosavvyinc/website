          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12">
                <h1 className="text-primary">User Experience Practitioner</h1>
                <h3>About the Position:</h3>
                <p>As a UX engineering team member, you will be joining a highly
                ...
                <p>It’s important that everyone on our team takes an iterative,
                  ...
                  flexibility, and constantly strive for on-time project delivery.</p>
                ...
                <h3>How to Apply:</h3>
                <p>Send an email to dana@neosavvy.com with UX Practitioner in the
                  subject line.</p>
